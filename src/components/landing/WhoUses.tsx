        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {categories.map((c, i) => (
            <FadeUp key={c.label} delay={i * 0.05} className="group">
              <div className="p-8 rounded-2xl bg-white/5 border border-white/10 transition-all flex flex-col items-center gap-5 hover:bg-white/10 hover:shadow-2xl hover:shadow-emerald-500/10">
