    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center animate-in fade-in duration-200">
      ...
      <div className="relative bg-white rounded-[.5em] p-8 max-w-sm w-full mx-4 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 py-3 px-4 rounded-[.5em] font-black text-xs uppercase tracking-widest text-slate-500 bg-slate-100 hover:bg-slate-200 transition-all"
          >
            {cancelText}
          </button>
          <button
            ...
            className={`flex-1 py-3 px-4 rounded-[.5em] font-black text-xs uppercase tracking-widest text-white shadow-xl transition-all ${
              isDestructive 
