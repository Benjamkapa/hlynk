...
export const salesApi = {
  list: (params?: { page?: number; search?: string; date?: string; status?: string; limit?: number; sortBy?: string; sortOrder?: string; includeStats?: boolean }) => api.get('/sales', { params }).then(r => r.data),
