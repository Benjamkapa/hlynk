...
function StatCounter({ value, suffix, label }: { value: number; suffix: string; label: string }) {
  ...
  return (
    <div ref={ref} className="text-center">
      <div className="font-bold font-ubuntu text-[clamp(1.8rem,4vw,2.8rem)] text-[#0D2419] leading-tight" style={{ fontFamily: "'Play', sans-serif" }}>
    ...
    <div className="bg-[#F5F7F8] text-[#161E2A] selection:bg-[#20C997] selection:text-white font-nunito">
      ...
      <header className={`fixed top-0 left-0 right-0 z-[100] bg-white/95 backdrop-blur-xl border-b border-[#E5E9EC] transition-transform duration-300 ${navVisible ? "translate-y-0" : "-translate-y-full"}`}>
        <div className="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/register" className="hidden sm:flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#20C997] text-white text-sm font-bold font-ubuntu shadow-lg shadow-[#20C997]/20 hover:bg-[#1ab785] hover:-translate-y-0.5 transition-all">Get Started Freely</Link>
      ...
      <div className={`fixed inset-0 z-[200] bg-white p-8 flex flex-col gap-8 transition-transform duration-500 lg:hidden ${menuOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <nav className="flex flex-col gap-6">
          {navItems.map(n => (
            <a key={n.label} href={n.href} onClick={() => setMenuOpen(false)} className="text-3xl font-bold font-ubuntu text-[#161E2A]">{n.label}</a>
          ))}
          <div className="h-[1px] bg-[#E5E9EC] w-full" />
          <Link to="/login" onClick={() => setMenuOpen(false)} className="text-3xl font-bold font-ubuntu text-[#20C997]">Log in</Link>
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 bg-gradient-to-br from-[#0D2419] via-[#0a3d28] to-[#0d5534] overflow-hidden min-h-[92vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 w-full grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeUp className="text-center lg:text-left">
            {/* <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#20C997]/15 border border-[#20C997]/30 text-[#20C997] text-[10px] md:text-xs font-bold font-ubuntu uppercase tracking-widest mb-6">
              <span className="animate-pulse">●</span> 🇰🇪 Built for Kenyan Business
            </div> */}
            <h1 className="text-4xl md:text-6xl xl:text-7xl font-bold font-ubuntu text-white leading-[1.1] mb-6 font-ubuntu">
              Run Your Business With Confidence.
              <br />
              <span className="text-[#20C997]">
                Know Your Numbers Every Day.</span>
            </h1>
            <p className="text-base md:text-lg text-white/60 leading-relaxed mb-10 max-w-lg mx-auto lg:mx-0">
              HudumaLynk provides a professional online presence and a powerful business dashboard — helping service providers track sales, manage inventory, and make smarter decisions.
            </p>
            {/* <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <Link to="/register" className="px-8 py-4 rounded-xl bg-[#20C997] text-white font-bold font-ubuntu text-base shadow-xl shadow-[#20C997]/30 hover:bg-[#1ab785] hover:-translate-y-1 transition-all flex items-center justify-center gap-2">
                Start Free — 14 Days <ArrowRight size={20} />
              </Link>
              <Link to="/login" className="px-8 py-4 rounded-xl bg-white/10 border border-white/20 text-white font-bold font-ubuntu text-base hover:bg-white/15 transition-all flex items-center justify-center">
                Log in
              </Link>
            </div> */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 md:gap-6 text-[10px] md:text-xs text-white/40 uppercase tracking-widest font-bold font-ubuntu">
      ...
      <div className="bg-white border-y border-[#E5E9EC]">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-6 items-center">
          <div className="text-center">
            <div className="font-bold font-ubuntu text-[clamp(1.2rem,3vw,1.8rem)] text-[#0D2419] uppercase tracking-widest font-ubuntu">Simple</div>
            <div className="text-sm text-[#7A8896] mt-1">No technical skills needed</div>
          </div>
          <div className="text-center">
            <div className="font-bold font-ubuntu text-[clamp(1.2rem,3vw,1.8rem)] text-[#0D2419] uppercase tracking-widest font-ubuntu">Professional</div>
            <div className="text-sm text-[#7A8896] mt-1">Digital records for your shop</div>
          </div>
          <div className="text-center">
            <div className="font-bold font-ubuntu text-[clamp(1.2rem,3vw,1.8rem)] text-[#0D2419] uppercase tracking-widest font-ubuntu">Reliable</div>
      ...
      <section id="features" className="py-24 md:py-32 bg-[#F5F7F8]">
        <div className="max-w-7xl mx-auto px-6">
          <FadeUp className="mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold font-ubuntu text-[#161E2A] leading-tight mb-6 font-ubuntu">Run your business. <br className="hidden md:block" /> Know your numbers.</h2>
            ...
            {features.map((f, i) => (
              <FadeUp key={f.title} delay={i * 0.05}>
                <div className="h-full bg-white p-8 rounded-2xl border border-[#E5E9EC] hover:border-[#20C997]/40 hover:shadow-2xl hover:shadow-[#0D2419]/5 transition-all group">
                  ...
                  <h3 className="text-lg font-bold font-ubuntu text-[#161E2A] mb-3 font-ubuntu">{f.title}</h3>
      ...
      <section id="how" className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <FadeUp className="text-center mb-16 md:mb-20">
            ...
            <h2 className="text-3xl md:text-5xl font-bold font-ubuntu text-[#161E2A] mb-6 font-ubuntu">Up and running in 3 minutes</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative">
            ...
            {[
              ...
              <FadeUp key={s.n} delay={i * 0.1} className="text-center">
                ...
                <h3 className="text-xl font-bold font-ubuntu text-[#161E2A] mb-4 font-ubuntu">{s.title}</h3>
      ...
      <section className="py-24 md:py-32 bg-[#F5F7F8]">
        <div className="max-w-7xl mx-auto px-6">
          <FadeUp className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold font-ubuntu text-[#161E2A] mb-6 font-ubuntu">Built for every service provider</h2>
      ...
      <section id="pricing" className="py-24 md:py-32 bg-[#0D0D0D] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <FadeUp className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-6xl font-bold font-ubuntu mb-6 font-ubuntu">Simple, honest pricing</h2>
            ...
            {pricingPlans.map((p, i) => (
              <FadeUp key={p.name} delay={i * 0.1}>
                <div className={`h-full p-10 rounded-[32px] flex flex-col relative overflow-hidden transition-transform hover:-translate-y-2 duration-300 ${p.badge ? "scale-105 z-10 ring-2 ring-[#20C997]/50" : ""}`} style={{ backgroundColor: p.color }}>
                  ...
                  <div className="text-xs font-bold font-ubuntu text-black/40 mb-2">{p.sub}</div>
                  ...
                  <Link to="/register" className="w-full py-4 rounded-2xl bg-[#0D0D0D] text-white font-bold font-ubuntu text-center hover:opacity-90 transition-opacity">
                    Get {p.name} Plan
                  </Link>
                </div>
              </FadeUp>
          ...
          <p className="text-center text-xs font-bold font-ubuntu text-white/30 uppercase tracking-widest mt-12">All plans include 14-day free trial · M-Pesa ready · Cancel anytime</p>
        </div>
      </section>
      ...
      <section id="reviews" className="py-24 md:py-32 bg-[#0D2419]">
        <div className="max-w-7xl mx-auto px-6">
          <FadeUp className="mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold font-ubuntu text-white leading-tight font-ubuntu">Business owners who finally <br className="hidden md:block" /> know their numbers</h2>
          </FadeUp>
      ...
      <section className="relative py-24 md:py-40 bg-gradient-to-br from-[#0D2419] via-[#0a3d28] to-[#0d5534] flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <FadeUp>
            {/* <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-[#20C997]/15 border border-[#20C997]/30 text-[#20C997] text-xs font-bold font-ubuntu uppercase tracking-widest mb-8">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 mb-16">
            <div>
              ...
              <p className="text-white/30 text-sm font-bold font-ubuntu tracking-widest">Your Business. Online. Today.</p>
            </div>
