      ...
      <div className="space-y-8 pt-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <button
            ...
            className="h-9 px-4 rounded-full text-sm font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-50 shadow-lg transition-colors flex items-center gap-2"
          >
